...
public class PHInput {
    ...
    PHInput() {
        ...
        storage = new PHStorage();
        output = new PHOutput();
    }
    
    // Khởi tạo với Scanner và PrintWriter
    PHInput(Scanner keyboard, PrintWriter out) {
        this.keyboard = keyboard;
        this.out = out;    
    }
    
    // Khởi tạo với Scanner, PrintWriter và Storage
    PHInput(Scanner keyboard, PrintWriter out, PHStorage storage) {
        this(keyboard, out);
        this.storage = storage;
    }
    
    // Khởi tạo với Scanner, PrintWriter, Storage và Output
    PHInput(Scanner keyboard, PrintWriter out, PHStorage storage, PHOutput output) {
